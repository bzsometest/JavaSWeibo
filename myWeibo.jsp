...
<body>
	...
	<div class="content">
		<!--更换背景-->
		<button class="theme">更换背景</button>
		<!--顶部个人资料-->
		<div class="title">
			<!--头像-->
					...
					<c:forEach items="${followList}" var="user" varStatus="status">
						...
						<div class="attention_man">
							...
							<div class="attention_man_right">
								...
								<!--关注按钮-->
								<div id="attention">
									<a href="userWeibo.do?uid=${user.uid}"><i>已关注</i></a>
								</div>
								<p>${user.sign}</p>
							</div>
						</div>
		...
		<div class="right">
			<!--发布微博-->
			<div class="send">
				<form action="addWeibo.action" method="post">
					<input type="hidden" class="tourl" name="tourl">
					<textarea name="content" id="comment_content" class="send_box"
						placeholder="随时随地，发现新鲜事！"></textarea>
					<button class="send_button">发布</button>
				</form>
			</div>
				...
				<div class="box">
					<div class="box_title">
						...
						<div class="box_right">
							...
							<!--删除按钮-->
							<div class="delete_weibo">
								<a href="deleteWeibo.do?wid=${weiboShow.weibo.wid}"><b>删除</b></a>
							</div>
							<!--发布时间-->
						...
						<c:forEach items="${weiboShow.discuss}" var="discuss"
							...
							<div class="box_comment_list">
								<p>
									...
									<!--删除评论按钮-->
									<a class="delete_comment_list"
										href="deleteDiscuss.do?did=${discuss.did}"> <b>删除</b>
									</a>
								</p>
